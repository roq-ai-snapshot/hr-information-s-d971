  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System: Streamline Your Business Operations with Our Comprehensive Platform for Managing Employee Data, Vacations, and Payroll."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System: Streamline Your Business Operations with Our Comprehensive Platform for Managing Employee Data, Vacations, and Payroll.`}
            </Text>
            <Box
